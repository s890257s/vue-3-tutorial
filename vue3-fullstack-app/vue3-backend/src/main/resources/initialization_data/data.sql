INSERT INTO [member] ([is_admin], [email], [password], [member_name], [point]) VALUES
(1, 'alice@example.com', '1234', N'愛麗絲', 100),
(0, 'bob@example.com', '1234', N'鮑伯', 80),
(0, 'charlie@example.com', '1234', N'查理', 120),
(0, 'dave@example.com', '1234', N'大衛', 50),
(0, 'eve@example.com', '1234', N'伊芙', 0),
(0, 'zoe@example.com', '1234', N'柔伊', 200);
