...
- [3-3 元件 Props (父元件傳遞資料至子元件)](#CH3-3)
  - [1. 基礎用法](#CH3-3-1)
  - [2. Props 驗證 (Validation)](#CH3-3-2)
  - [3. 單向資料流 (One-Way Data Flow)](#CH3-3-3)
  - [4. 重點整理](#CH3-3-4)
  - [5. 單向資料流？有時候事情並沒有這麼簡單...](#CH3-3-5)
- [3-4 Emit (子元件傳遞事件至父元件)](#CH3-4)
  - [1. 基礎用法](#CH3-4-1)
  - [2. 觸發自定義事件前的驗證](#CH3-4-2)
  - [3. 進階技巧與 v-model](#CH3-4-3)
  - [4. 重點整理](#CH3-4-4)
- [3-5 provide / inject (跨層級資料傳遞)](#CH3-5)
  - [1. 痛點：Props Drilling (逐層傳遞)](#CH3-5-1)
  - [2. 基礎用法](#CH3-5-2)
  - [3. 響應式與修改](#CH3-5-3)
  - [4. 什麼時候該用？](#CH3-5-4)
- [3-6 元件生命週期 (Lifecycle Hooks)](#CH3-6)
  - [1. 生命週期總覽](#CH3-6-1)
  - [2. 常用 Hooks 與範例](#CH3-6-2)
  - [3. 重點與最佳實踐](#CH3-6-3)
- [3-7 Slot (插槽)](#CH3-7)
  - [1. 預設插槽 (Default Slot)](#CH3-7-1)
  - [2. 具名插槽 (Named Slots)](#CH3-7-2)
  - [3. 作用域插槽 (Scoped Slots)](#CH3-7-3)
  - [4. 作用域插槽常見使用情境](#CH3-7-4)
  - [5. 重點整理](#CH3-7-5)
- [3-8 動態元件 (Dynamic Components)](#CH3-8)
  - [1. 基本用法 `<component :is>` ](#CH3-8-1)
  - [2. 保持存活 `KeepAlive`](#CH3-8-2)
- [3-9 Plugins (插件)](#CH3-9)
  - [1. 什麼是插件 (Plugins)？](#CH3-9-1)
  - [2. 簡易插件實作 (初學者只需知道即可)](#CH3-9-2)
  - [3. 實戰：使用外部套件 (以 vue-toastification 為例)](#CH3-9-3)
- [3-10 元件拆分策略](#CH3-10)
  - [1. 拆分原則](#CH3-10-1)
  - [2. 異步元件 (Async Components) - 效能優化](#CH3-10-2)
...
在 Vite 專案 (SFC) 中，Vue 3 官方推薦使用 **`<script setup>`** 語法糖。這能讓程式碼大幅簡化：
...
在 Vue 開發中，遵循一致的命名慣例非常重要，這能提高程式碼的可讀性並避免潛在錯誤。官方建議遵循 [Style Guide](https://vuejs.org/style-guide/) 的規範：
...
在實際開發中，我們建議對 Props 進行**型別驗證**，這有點像是為你的元件寫一份說明書，明確告訴使用這個元件的開發者（包含你自己）：「這個元件需要什麼資料？應該是什麼類型？有沒有預設值？」
